...
public class Main {
    public static void main(String[] args) throws SQLException {
       ...
       /* //----------CRUD - Authors--------
        ...
        authorDAO.updateAuthor(26, "Tudor", "Vianu");
        
        System.out.println("Deleting an author...");
        authorDAO.deleteAuthor(authorDAO.getAuthorByID(24)); 
        ...
        while (iterator.hasNext()) {
            ...
            Authors author2 = Factory.getInstance().getAuthorDAO().getAuthorByID(book.getAuthor().getId());
       ...
       /* bookDAO.deleteBook(bookDAO.getBookByID(29));
